...
func TestLinkedListNewWithOptionalParams(t *testing.T) {
	...
	_, err := client.LinkedList.New(context.TODO(), brucetestapi.LinkedListNewParams{
		LinkedNode: brucetestapi.LinkedNodeParam{
			Value: "a",
		},
	})
	if err != nil {
