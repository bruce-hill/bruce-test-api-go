...
<a href="https://pkg.go.dev/github.com/bruce-hill/bruce-test-api-go/v2"><img src="https://pkg.go.dev/badge/github.com/bruce-hill/bruce-test-api-go.svg" alt="Go Reference"></a>
...
```sh
go get -u 'github.com/bruce-hill/bruce-test-api-go@v2.1.0'
```
