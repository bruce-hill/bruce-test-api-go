...
<a href="https://pkg.go.dev/github.com/DefinitelyATestOrg/test-api-go"><img src="https://pkg.go.dev/badge/github.com/DefinitelyATestOrg/test-api-go.svg" alt="Go Reference"></a>
...
```go
import (
	"github.com/DefinitelyATestOrg/test-api-go" // imported as brucetestapi
)
```
...
```sh
go get -u 'github.com/DefinitelyATestOrg/test-api-go@v0.20.0'
```
...
See the [full list of request options](https://pkg.go.dev/github.com/DefinitelyATestOrg/test-api-go/option).
...
We are keen for your feedback; please open an [issue](https://www.github.com/DefinitelyATestOrg/test-api-go/issues) with questions, bugs, or suggestions.
