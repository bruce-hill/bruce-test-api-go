...
func TestUserAgentHeader(t *testing.T) {
	...
	client.People.Get(context.Background(), "ID")
...
func TestRetryAfter(t *testing.T) {
	...
	_, err := client.People.Get(context.Background(), "ID")
	if err == nil {
...
func TestContextCancel(t *testing.T) {
	...
	cancel()
	_, err := client.People.Get(cancelCtx, "ID")
	if err == nil {
		t.Error("Expected there to be a cancel error")
	}
}
...
func TestContextDeadline(t *testing.T) {
	...
	go func() {
		...
		_, err := client.People.Get(deadlineCtx, "ID")
		if err == nil {
